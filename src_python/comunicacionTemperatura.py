...
try:
    ...
    MODEL_PATH = os.path.join(script_dir, '/home/laura/Documents/uni/investigacion/codigo/bb_project/ibex-lib/src_project/Arquitecturas/mlp_3_tanh_temperature.keras')
    SCALER_PATH = os.path.join(script_dir, '/home/laura/Documents/uni/investigacion/codigo/bb_project/ibex-lib/src_project/Arquitecturas/scaler_3_tanh_temperature.pkl')
